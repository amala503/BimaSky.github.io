...
class ACL
{
	...
	public static $role_pages = array(
			'account manager' =>
						array(
							'faq' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'pelanggan' => array('list','lihat_pic', 'view','add','edit', 'editfield','delete','import_data','approve'),
							'produk' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'promo' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'pic_perusahaan' => array('view'),
							'alamat_perusahaan' => array('view')
						),
		
			'operasional' =>
						array(
							'pesanan' => array('list','view','add','edit', 'editfield','delete','import_data')
						)
		);
