...
class PengirimanController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				pengiriman.id LIKE ? OR 
				pengiriman.nama_pengiriman LIKE ? OR 
				pengiriman.biaya LIKE ? OR 
				pengiriman.estimasi_waktu LIKE ?
			)";
			$search_params = array(
				"%$text%","%$text%","%$text%","%$text%"
			);
		...
		if(!empty($request->orderby)){
			...
			$db->orderBy("pengiriman.id", ORDER_TYPE);
		}
		if($fieldname){
	...
	function view($rec_id = null, $value = null){
		...
		if($value){
			...
			$db->where("pengiriman.id", $rec_id);; //select record based on primary key
		}
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("nama_pengiriman","biaya","estimasi_waktu");
			...
			$this->sanitize_array = array(
				'nama_pengiriman' => 'sanitize_string',
				'biaya' => 'sanitize_string',
				'estimasi_waktu' => 'sanitize_string',
			);
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","nama_pengiriman","biaya","estimasi_waktu");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'nama_pengiriman' => 'required',
	...
	function delete($rec_id = null){
		...
		$db->where("pengiriman.id", $arr_rec_id, "in");
