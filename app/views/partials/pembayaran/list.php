                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-tanggal_bayar"> Tanggal Bayar</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-id"><a href="<?php print_link("pembayaran/view/$data[id]") ?>"><?php echo $data['id']; ?></a></td>
                                                    <td class="td-tanggal_bayar"> <?php echo $data['tanggal_bayar']; ?></td>
                                                    <td class="td-status">
                                                        <span <?php if($can_edit){ ?> data-value="<?php echo $data['status']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("pembayaran/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="status" 
