<?php
	...
	// Buat instance BaseController untuk mendapatkan notifikasi
...
<html>
	<head>
		...
		<?php 
			...
			Html ::  page_css('bootstrap-4.3.1.min.css');
			Html ::  page_css('custom.css'); // Pastikan file CSS kustom dimuat
		?>
				<?php 
