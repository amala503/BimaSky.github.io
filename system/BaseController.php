...
class BaseController{
	...
	function __construct(){
		...
		$this->file_upload_settings['gambar_produk'] = array(
			"title" => "{{random}}",
			"extensions" => "",
			"limit" => "1",
			"filesize" => "3",
		...
		$this->file_upload_settings['gambar_promo'] = array(
			"title" => "{{random}}",
			"extensions" => "",
			"limit" => "1",
			"filesize" => "3",
		...
		$this->file_upload_settings['bukti_transfer'] = array(
			"title" => "{{random}}",
			"extensions" => ".jpg,.png,.gif,.jpeg",
			"limit" => "1",
			"filesize" => "3",
	...
	function render_view($viewname, $data = null, $layout = "main_layout.php"){
		if($this->return_value){
			...
			// Tambahkan notifikasi ke view
			$notifications = $this->getNewOrderNotifications();
			$this->view->set_page_data('newOrderNotifications', $notifications);
			$this->view->set_page_data('notificationCount', count($notifications));
